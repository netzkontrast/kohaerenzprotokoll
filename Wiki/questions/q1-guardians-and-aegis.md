...
# Q1 — how do the Guardians relate to AEGIS?
...
One dependent clause, in `entropie-aegis`:
...
component of [[aegis|AEGIS]], a peer, or an earlier design.

And `guardians-und-kern-welten-konzept` — 5,839 words specifying five [[guardians|Guardians]]
and four worlds — **never mentions [[aegis|AEGIS]] at all.** Zero occurrences.
...
[[guardians|Guardians]], where it belongs, with the chapter around it.

## Related

`Wiki/conflicts/c4-guardians-and-aegis.md` — the same subject from the other
side. C4 records that two documents disagree about whose blind spot it is; Q1
records that nothing read says how the two entities relate.
...
The document never asks the question. Document 5 built a chapter out of asking
it; this one does not raise it once in 12,022 words, which is a different kind of
evidence: **not an answer, but the shape of an assumption that nobody in this
document thought needed arguing.**

So Q1 narrows again and does not close. Two documents now support *components*;
...
[[mnemosyne|Mnemosyne]] is „die einzige Stimme im AEGIS-System, die mehr Wahrheit kennt als AEGIS — und schweigt" ^[kohaerenz-protokoll-welt-sensorik-drafting-2026-06-10-md.md:L696]
— a voice in the system, which is not the same as a component of it.
