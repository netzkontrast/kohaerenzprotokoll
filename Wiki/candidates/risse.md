...
Defined as a **consequence**, which is the useful part — most of this document's
terms are defined by function, this one by cause:

> „Die \"Risse\" […] können nun als **direkte Manifestationen einer Zunahme von
> Entropie** interpretiert werden, die AEGIS' Kontrollkapazität übersteigt."
> ^[entropie-aegis.md:L94]
...
And they are [[aegis|AEGIS]]' failure made visible:
...
kinetic, Kiko temporal, Kiko/Lia spatial, Moros gravitative, Isabelle sensory, Silas
