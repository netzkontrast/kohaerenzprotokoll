...
Kael's workplace in KW1, and where he first meets an anomaly.

## Reading — `roman-lokalitaeten-konzept-und-ausarbeitung`, 2025-04-18

The master list gives four facts in one row ^[roman-lokalitaeten-konzept-und-ausarbeitung.md:L188]:
...
| associated characters | Kael, LogOS (Systempräsenz) |
...
The symbolism is stated as a claim about the system rather than about the room:
...
Note the phrase `'Risse' in den Daten` — a Riss appearing as a data defect rather
than as a break in a room. See `risse`.
