...
49 <!--state:pairs.labelled--> pairs and `fold()` decides
29 <!--state:pairs.fold_correct--> — 59%. When this was written it was 36 and 21,
58%, which `NOW.md` had already measured; documents 7 and 8 added fourteen
rows.
