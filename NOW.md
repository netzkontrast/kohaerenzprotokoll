...
8. **Every reconciliation ends with `reconcile.py --sweep-open` printing
   ...
   33 <!--state:sweep.decided--> hits, 17 <!--state:sweep.readings--> of them
...
## Next document — the konzept master report reconciled
