...
- `glossary_terms` — codex slugs from the partition indexes under
  `Codex/entries/<category>/README.md` (`Codex/GLOSSARY.md` routes to them and
  carries no entries itself), or a trigger scan of
  `Graph/nodes/codex_entry.jsonl` against the claim text
