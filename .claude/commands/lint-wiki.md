...
`wiki-maintenance` skill first. Deterministic `page-location`, `page-size`, and
rendered-index checks belong to `scripts/wiki_lint.py`; this command adds
semantic corpus review and never hand-edits an index.
