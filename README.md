...
4. `python3 scripts/lit_critic_gate.py --chapter N` — [lit-critic](https://github.com/lit-pack/lit-critic)
   prüft zuerst die kapitelgenauen Canon-Locks ([scripts/lit_critic_locks.py](scripts/lit_critic_locks.py),
   ...
   die Locks laufen mit `--locks-only` auch ohne. Nur `critical`-Findings blockieren.
