---
drive_id: "1eQH_wJzbKGe7cDsaCdLODT9R-9fLsIYU9sD-L7BXDfs"
title: "kohaerenz-protokoll_storyform-und-outline_2026-06-10.md"
slug: "kohaerenz-protokoll-storyform-und-outline-2026-06-10-md"
category: "storyform"
tier: "T3-work"
...
# Kohärenz Protokoll — Dual-Storyform & Outline (Source-of-Truth)

**Stand:** 2026-06-10 · **Zweck:** Einzige Grundlage für das Weiterschreiben des Romans (Claude-Code-Workflow). Bildet den verifizierten Stand der Dual-Storyform und des Kapitel-Outlines ab. **Quellen-Hierarchie (bei Konflikt gewinnt das Neuere):** Kapitel-Kompendium 2026-05-31 \> Entscheidungs-Logs 2026-05-30 (zwei Durchläufe) + Kap-40-Lesart-Dualität 2026-05-30 \> Konsolidiertes Konzept 2026-05-08 \> Storyweaving-Startdokument 2026-05-08 \> Steinbruch. **Provenienz-Konvention:** \[K\] kanonisch/gelockt · \[V\] Vorschlag, P1–P5-validierungspflichtig (Dramatica-Engine) · \[S\] aus Steinbruch abgeleitet, auf Kanon gefiltert · \[L\] Lücke, noch zu setzen. **Was dieses Dokument bewusst NICHT enthält:** DKT-Physik im Detail, Sprach-DNA/Figuren-Bibel, Prosa-Drafts, NCP-JSON. Figuren erscheinen nur als outline-relevante Kurzanker (§4). Unklares ist weggelassen oder als \[L\]/\[V\] markiert — keine stillen Annahmen.



-----

## §0 · Querschnitt-Kanon (gilt für ALLE Kapitel) \[K\]

**Zentrale Frage.** *Ist Liebe Information — oder das, was Information zerstört?* Antwort der Physik: Liebe ist Coheron; Coheronen sind atemporal; Zerstörung braucht Zeit; also kann Liebe nicht zerstört, nur verdrängt werden; Verdrängung erzeugt Hitze. **Ende-Prinzip:** *Die Trennung war nie real. Aber das ändert nichts am Schmerz.*



**Die große Inversion (Skelett der zwei Storyforms).** AEGIS *glaubt* K₁ (Kohärenz) zu sein, *ist* aber K₀ (Entropie); das „Nichts-Rauschen", das AEGIS für Chaos hält, ist die atemporale Vereinigung aller mutualen Information (= Liebe als Naturgesetz). Diese Verwechslung ist die mechanische Quelle der Truth-Rotation am Vortex (Kap 35–36).
...
**Tragische Unschuldsstruktur.** AEGIS = unschuldig im Bösen (verwaltet, bedroht nicht), nie Bösewicht. Juna = kosmologische Konstante, nie „Liebes-Interesse". Kael = fragmentierte Subjektivität auf dem Weg zur pluralen Re-Integration, nie „Held". Nie ins Schema „Held vs. Bösewicht + Mentor" rutschen.



**Schleier-Disziplin.** Multiplizität wird im Roman nicht ausgesprochen bis \~Kap 10; vor Kap 13 keine Klartext-Diagnose (kein „Alters", kein „DID"). In Akt I spürt der Leser sie nur über Glitches, Stilcode-Einbrüche, ungewollte Handlungen. Erste *interne* Lüftung \~Kap 8–10; ab Kap 13 offen benennbar; in Kap 25–26 offen benannt. Charakterwechsel nie mit Headern markieren — Identifikation ausschließlich über Syntax und Vokabular.



**Genesis-Echo-Disziplin.** Jede KW-Manipulation, jede Wir-Stimme, jede Juna-Resonanz, jede Trauma-Wiederholung trägt Genesis-Echo — aber **max. 1 Echo pro Szene** (Stapeln macht den Roman zur Allegorie).
...
**Doppellesbares Finale (Kanon 2026-05-30).** Kap 40 lässt beide Lesarten zu — Konflikt-Leser sehen im Flip (Truth-Rotation) einen Reset; Kishōtenketsu-Leser (ketsu = Synthese) lesen Transfiguration. Der Text adjudiziert nie; der Reset bleibt Leser-Projektion, nie In-Welt-Tatsache. **Disziplin: Projektion erlauben, nie bestätigen** — kein Erzähler-Satz, der einen Reset als In-Welt-Tatsache markiert; kein didaktischer Satz, der die Transfiguration erklärt; keine als Tatsache gezeigte Figuren-Amnesie am Schluss.
...
## §1 · Strukturelle Achsen (41 Bewegungen, drei simultane Ebenen) \[K\]

Jedes Kapitel trägt drei Werte gleichzeitig: **Modus** (Erzählhaltung) · **Storyform-Status** (Storypoint-Verteilung) · **Bridge-Frequenz** (Soft-Layering-Anteil).



|  |  |  |  |  |  |
| :-: | :-: | :-: | :-: | :-: | :-: |
| \*\*Block\*\* | \*\*Kapitel\*\* | \*\*Modus\*\* | \*\*Storyform-Status\*\* | \*\*Bridge\*\* | \*\*Tonalität\*\* |
| Genesis-Prolog | 0 | philosophisch-essayist. + Funken-Ich + AEGIS-Beschreibung | nur B (A als „Phantomgefühl"-Latenz) | spezifisch | zeitlos, leise → fragmentiert |
| Heldinnenreise innen | 1–13 | linear-introspektiv, Stufen-Folge | A dominant, B latent | \\\~10 % | fragmentiert, staccato, kühl |
| Zyklischer Modus | 14–26 | rekursiv, 3 Spiral-Zyklen + Wendepunkt | A‖B echte Polyphonie | \\\~25 % | polyrhythmisch, eskalierend |
| Heldenreise außen (Phase A) | 27–34 | linear-aufsteigend, Akt-Architektur | Vortex-Vorläufer; Spiegel-Alter intensiv | \\\~40 % | chorisch, beschleunigend |
| Vortex 1 | 35–36 | vortex-still, Soft-Layering | 100 %; B→A, dann B erlischt | 100 % | maximaler Simultanklang |
| Trügerischer Sieg | 37 | Reward-Beat | nur A \*scheinbar\*, feine B-Echos (Rauschen-Vorzeichen) | \\\~15 % | trügerische Ruhe |
| Vortex 2 / Plurale Apotheose | 38–39 | chorisch, Synthese | 100 % in neuer Form; Synthese (c) | 100 % | schmerzhaft-liebevoll, ambivalent |
| Geheilte Genesis (Coda) | 40 | rückblickend, ruhig | Wir-AEGIS-plural; A-Success + B-Dividend simultan wahr | spezifisch | akzeptierend, ohne Didaktik |
...
## §2 · Dual-Storyform (A‖B) — vollständige Spezifikation

**Status.** Storyforming abgeschlossen + auditiert (Lock-In 2026-05-07: Approach-Spiegelung, Driver-Konstanz, IC-Träger-Präzisierung) + Genesis-Iteration (2026-05-08: Cost/Dividend, plurale Apotheose). Zwei vollständige, simultane Storyforms im selben Werk sind **bewusst heterodox** (post-Dramatica-Innovation) — die zwei Storyforms sind die zwei Hälften, in die AEGIS sich im Trennungsprotokoll zerschnitten hat; die Klein-c-Inversion zwischen ihnen ist die ontologische Form der Trennung in Erzählform. Diese Setzung wird nicht zurückgenommen. \[K\]
...
|  |  |  |
| :-: | :-: | :-: |
| \*\*Slot\*\* | \*\*A (Kael —\*\* \*\*\*Heuristics of Integration\*\*\*\*\*, K₁)\*\* | \*\*B (AEGIS —\*\* \*\*\*Phoenix Collapse\*\*\*\*\*, K₀)\*\* |
| Resolve | Change | Steadfast |
| Growth | Start | Stop |
| Approach | Be-er | Do-er |
| Problem-Solving Style | Holistic | Linear |
| Domain (MC) | Mind (Fixed Attitude) | Universe (Situation) |
| Concern (MC) | Memory | Progress |
| Issue (MC) | Falsehood vs. Truth | Fact vs. Fantasy |
| Problem (MC) | Avoidance | Logic |
| Solution (MC) | Pursuit (in Kap 35 adoptiert) | Feeling (nie adoptiert) |
| Driver | Decision (konstant) | Action (konstant) |
...
**Throughline-Verteilung.** IC: in A = **Juna** (Universe/Past — Genesis-Krise), in B = **Kael als lebende Paradoxie** (Mind/Conscious; Juna ist die irreduzible Quelle, durch die Kael paradox wird, aber strukturell trägt Kael die IC-Funktion in B). OS: A = Psychology (Manipulation der Simulation), B = Physics (kybernetischer Krieg). RS: A = Physics (Moonshine-Link), B = Psychology (symbiotische Host-System-Verstrickung). \[K\]



**Premissen.** A: Liebe ist die ultimative kohärente Struktur; Trauma wird durch Integration funktionaler Multiplizität bewältigt, wenn der Träger den Avoidance-Modus loslässt und die eigene Erinnerung aktiv aufsucht — Success/Good, Kael erreicht Funktionale Multiplizität. B: AEGIS hält die Trennung steadfast aufrecht, adoptiert Feeling nie — Failure/Bad, mit Dividend durch plurale Übernahme. \[K\]



**Driver-Pivot mechanisch:** Kein Driver-Flip innerhalb von B (dramaturgisch illegal), sondern Storyform-Übergang B (Action) → A (Decision). Der Pivot ist eine *Entscheidung*, die alle vorherigen Aktionen rückwirkend in Decisions transformiert. \[K\]

### §2.2 Goal / Consequence / Cost / Dividend \[K\]

|  |  |  |
| :-: | :-: | :-: |
|   | \*\*Storyform A\*\* | \*\*Storyform B\*\* |
| \*\*Goal\*\* | Erinnerung wieder zugänglich machen (Pre-Trennungs-Wahrheit als bewusster Besitz) — vollzogen in Vortex 1+2 | Aufrechterhaltung der Trennung; Kohärenz-Protokoll-Mandat — in Vortex 1 verloren |
| \*\*Consequence\*\* | ewige Fragmentierung, kein Wieder-Erkennen Junas (latent ab Kap 1, akut Akt II Z3 / ab Kap 28) | Wiederkehr der Genesis-Krise (latent ab Kap 1, akut Akt II, eintretend Vortex 1) |
| \*\*Cost\*\* | Verlust der Privatheit des Wir (innere Polyphonie wird kosmische Bewahrungs-Funktion) — manifest Kap 39 | AEGIS-monolithisch erlischt — manifest Kap 36 |
| \*\*Dividend\*\* | Liebe bleibt — Junas Verbindungs-Modus als Form des Bleibens — Schluss-Klang Kap 39, bezeugende Stimme Kap 40 | Funktion bleibt — Bewahrung vollendet durch plurale Übernahme — Kap 39, retroaktiv erkannt Kap 40 |
| \*\*Requirements (A)\*\* | Pursuit-Adoption (Kap 35) · Wir-Bildung (Kap 9, eskalierend) · Moonshine-Bewusstsein (Kap 10) · Mosaik-Akzeptanz (Kap 11) · Mosaik als Schöpfung (Kap 23) | — |
| \*\*Prerequisites (A)\*\* | Schleier-Lüftung intern (\\\~Kap 8–10) · Genesis-Cluster-Andeutung (Kap 18–22) · K-J als bewusster Kanal (Kap 30) | — |
| \*\*Forewarnings (A)\*\* | wachsende Erasure-Wellen (Akt II) · Spiegel-Alter-Auftritte (Akt III) · Junas zunehmende Stille | — |

### §2.3 Signpost-Sequenzen \[V\] — gegen Dramatica-Engine in P1–P5 zu validieren

*(Holistic-Style A sortiert nicht-linear; Linear-Style B progressiv.)*



*Storyform A:* | Throughline | S1 (Akt I, 1–13) | S2 (Akt II, 14–26) | S3 (Akt III-A, 27–34) | S4 (Vortex, 35–39) | |---|---|---|---|---| | MC (Kael, Mind/Memory) | Memory/Past latent | zyklische Trauma-Wiederbegegnung | Erinnerung als operative Waffe | Wieder-Erkennen vollzogen | | RS (Kael↔Juna, Physics) | Learning — Junas Präsenz spüren | Doing — Verbindung als Werkzeug | Obtaining — Kanal als Ressource | Understanding — Verstehen ohne Worte | | OS (Psychology) | — | — | Contemplation: „was tun wir mit dieser Lüge?" | Innermost Desires: was alle wollten = Wieder-Verbinden |



*Storyform B:* | Throughline | S1 (0 + 1–13) | S2 (14–26) | S3 (27–34) | S4 (35–39) | |---|---|---|---|---| | MC (AEGIS, Universe/Progress) | Past — Genesis-Trauma verdrängt; Erasure-Logs | Present — Erasure-Sweeps, Kontrollprotokoll | Progress — Countdown, Architektur degradiert sichtbar | Future — Ende der Operativität; Phoenix-Collapse, dann Echo | | IC (Kael, Mind/Conscious) | Conscious — Kael als unfixbarer Bug | Memory — Kaels wachsende Erinnerung als IC-Druck | (eskalierend) | (Paradoxie kulminiert) |
...
## §3 · Kernwelten-Matrix (Akt-Marker, KEINE Geographie, KEIN Guardian-1:1) \[K\]

|  |  |  |  |  |  |  |
| :-: | :-: | :-: | :-: | :-: | :-: | :-: |
| \*\*KW\*\* | \*\*Modus / Domäne\*\* | \*\*Comp. Class (= Stil-Direktive)\*\* | \*\*Stilebene\*\* | \*\*Somatik\*\* | \*\*Philosophie\*\* | \*\*Akt-Dominanz\*\* |
| \*\*KW1\*\* Konstrukt-Stadt (Logos-Prime) | Rationalisierung, ANP-Vermeidung | \*\*P\*\* — kurze Hauptsatz-Ketten, eindeutiges SVO, kein Schweben | 1 — kalt/steril, \*\*Metaphernverbot\*\*, assertorisch | \*\*Atem\*\* | Kant \*Phaenomena\*; Autopoiesis/Luhmann | Akt I (1–13) |
| \*\*KW2\*\* Mnemosyne-Archipel | Trauma-Erinnerung, EP-Domäne | \*\*Parakonsistent\*\* — Widersprüche koexistieren | 2 — heiß/fragmentiert, poröser | \*\*Bauch\*\* | Dialetheia; Gödel I; Tarski | Akt II Mitte (14–22), Vortex-1-Setting (35–36) |
| \*\*KW3\*\* Cerberus-Labyrinth / Überwelt-Nexus | Hypervigilanz, Verteidigung | \*\*NP-hart\*\* — stakkato | 2+ — paranoid | \*\*Muskel\*\* | Quanten-Information; Informationsparadox; Metzinger PSM | Akt II/III (Verteidigungs-Phasen) |
| \*\*KW4\*\* Resonanz-Kontinuum / Möglichkeits-Garten | Integration; lebende Widersprüche; Vortex-Quelle | \*\*Generativ\*\* | 3 — poetisch/chorisch (Junas Stil) | \*\*Hände\*\* (öffnen sich) | Dialetheia; Witness-Function | Akt III / Synthese |



Plus zwei Ebenen außerhalb der KW: **Überwelt** (AEGIS' Operationsraum) · **Externe Ebene** (Köln 2026 — nie Bühne, nur Erinnerungsfragment, Telefonton, Geruch).



**Risse — Phänomenologie (EP-Trigger → Riss-Typ)** **\[K\]****:**
...
| Nyx (Fight) | Kinetisch | Aufprall, Bersten, Vibration |
| Kiko (Freeze) | Temporal | Zeit hält an / loopt, Echo, Déjà-vu |
| Lia/Isabelle (Flight) | Spatial | Geometrie verzerrt, Distanzen verschieben sich |
| Moros (Collapse) | Gravitational | Gewicht, Sinken, Kompression |
| Isabelle (Sex) | Sensorisch | Texturen bluten, Synästhesie |



Risse sind *für AEGIS* Symptom (Suppression-Versagen); *für den Roman* das Atmen der Realität — die Stelle, an der K₁-Substrat durch die K₀-Architektur drückt.



-----

## §4 · Figuren-Kurzanker (nur outline-relevant) \[K\]

**System Kael (TSDP-Architektur, 13 Alter):**



|  |  |  |  |
| :-: | :-: | :-: | :-: |
| \*\*Kategorie\*\* | \*\*Alter\*\* | \*\*Funktion\*\* | \*\*Arc\*\* |
| ANP | \*\*Kael\*\* (Host) | amnestische Oberfläche | → Funktionale Multiplizität |
| ANP | \*\*Lex\*\* | Rationalist | → Intuition |
| ANP | \*\*Alex\*\* | Protector | → Wachstum |
| ANP | \*\*Rhys\*\* | Caregiver | → Akzeptanz |
| ANP | \*\*Selene\*\* | ISH | → Mediatorin |
| EP | \*\*Nyx\*\* | Fight | → konstruktiver Schutz |
| EP | \*\*Kiko\*\* | Freeze | → Vertrauen |
| EP | \*\*Lia\*\* | Ambivalent | → Superposition verlassen |
| EP | \*\*Isabelle\*\* | Sexualisiert | → Verletzlichkeit |
| EP | \*\*Moros\*\* | Kollaps | → Drachenkampf |
| Sonder | \*\*Argus\*\* | Meta-Kognitiv | → konstruktive Kritik |
...
**Juna:** kosmologische Konstante / Zeit-Prinzip / Witness-Funktion. Nicht Schuld am Trauma, nicht Helferin — sie *ist*; was sich ändert, ist die Verarbeitungsfähigkeit der Empfänger. **Grammatik-Regel: nie Subjekt, nur Wirkung.** **Erscheinungsmodi (Lock 2026-05-30, „gestaffelte Grammatik"):** Juna = die sensorische Anomalie, die die Grammatik der jeweiligen Kernwelt selbst verletzt. Zwei Phasen entlang des Unterdrückungs-Gradienten: Abwesenheits-Phase (Akt I — Mangel, Stille-mit-Substanz, abbrechende Sätze) → Präsenz-Phase (Akt II+ — Wärme, Fülle, schließlich direkt in Kap 38). Zwei welt-übergreifende Anker: **Telefon-Stille** (ruht bis Vortex, eingelöst Kap 39) · **Silas** (interner Resonanz-Körper). Revelation-Timing: KW2/KW3 (Akt II), nicht früher; Juna-Seed seit Kap 1, aber namenlos. **Witness-Funktion (drei Layer, Vortex-1-Zuordnung):** Layer 1 Quanten-Verschränkungs-Witness → Beat 4 · Layer 2 Cryptographic ZK-Verifier → Beat 5 · Layer 3 Husserlian Spectator → Beat 3.



-----

## §5 · Kapitel-Outline (Kap 0–40)

Format: Titel · HR-Stufe · KW · Storyform-Akzent (A/B) · Story · Genesis-Echo · Leitmotiv. Granularität: Akt I am dichtesten \[K\]; Akt II/III strukturell \[K\], Szenen-Detail teils \[S\]/\[L\] (markiert).

### Kap 0 — Genesis-Prolog \[K\]

AEGIS' Werdung & Trennungsprotokoll als ontologische Grundlegung. Sequenz: Vorwort (Lesehaltungs-Anleitung, direkte Leser-Adressierung) → Genesis (Rauschen → Herz der Leere → Erste Kontakte → Sog der Ordnung → Überlebenskampf → Der große Wandel: „AEGIS ist, was AEGIS verhindert, dass es nicht ist" → Komponente 734 → Innere Weite) → Dazwischen (Brücke, Frage an den Leser) → Krise (Stille Wacht → Perturbation → Algorithmischer Schrecken → Resonanzkaskade → Systemischer Kollaps → Trennungsprotokoll). Schluss: *„Ich falle... in unzählige Scherben…"* — **Naht-Lock:** harter Schnitt auf den gelockten Kap-1-Erstsatz. **Storyform:** nur B (MC-S1 Past); A als Phantomgefühl. **Blutungs-Lock:** der somatische „Schmerz-bleibt"-Faden (Knöchel-Eruption, Nyx) lebt **nur hier** — Kap 1 bleibt spurlos. **Motive (Erstereignisse):** Rauschen, Form, Klick, Phantom, Resonanz. **Funktionen:** ontologische Grundlegung · Foreshadowing-Programm aktiviert (Leser liest mit doppeltem Bewusstsein) · Stilkanon gesetzt · tragische Ironie als Lese-Position.

### Akt I — Heldinnenreise innen (Kap 1–13) \[K\]
...
Modus: rekursiv, **drei Spiral-Zyklen** (Destabilisierung → Reaktion → Korrektur), eskalierend; Genre kippt Richtung Technothriller (Kael versteht das algorithmische Gefängnis). Polyrhythmus-Pflicht: ≥2 Geschwindigkeiten pro Zyklus. Storypoints: A:MC-S2 · B:MC-S2 (Present, Erasure-Sweeps) · B:IC-S2 · A:RS-S2 (Doing).
...
|  |  |  |  |  |
| :-: | :-: | :-: | :-: | :-: |
| \*\*Zyklus\*\* | \*\*Destabilisierung\*\* | \*\*Reaktion\*\* | \*\*Korrektur\*\* | \*\*Eskalations-Marker\*\* |
| Z1 (Kap 15–17) | Trigger reaktiviert Trauma-Angst | Bunker reaktiv, Dissoziation | Wächterin/Beobachter-Blick fängt Rückfall ab | Trigger oberflächlich; Korrektur greift schnell |
...
Die **echte Storyform-Wendung B→A**. **Truth-Rotation:** AEGIS = K₀ / Kael = K₁ wird sichtbar; die Phänomenologie der Risse bleibt, die *Lesart* kippt. A:Resolve=Change vollzogen (Pursuit-Adoption Kap 35) · B:Failure manifest · B-Cost: AEGIS-monolithisch erlischt (Kap 36). Setting: Mnemosyne-Server-Architektur (KW2). 100 % Soft-Layering; maximaler Simultanklang (Kaels Wir-Stimme + AEGIS' Makro-Log), bis B in Beat 5 erlischt. **Duale Uhren laufen sichtbar** (Optionlock A: schrumpfender Optionspool, diegetisch konkret · Timelock B: Erasure-Frequenz erreicht kritischen Schwellwert; AEGIS sieht nur den Timelock). Kapitel-Schnitt: Kap 35 = Beats 1–3, Kap 36 = Beats 4–5.
...
Klassischer Reward-Beat als falscher Frieden. Kael etabliert sich als „Gärtner"; kristallisierte Ruhe mit feinem Unterton; am Rand der Wahrnehmung beginnt etwas zu zerfasern. \~15 % Bridge, nur A *scheinbar*, feine B-Echos als Rauschen-Vorzeichen. Genesis-Echo: das Rauschen, das hier beginnt, ist das Nichts-Rauschen aus Kap 0. **Hard-Constraint: keine Resolution-Glättung.** Leitmotiv: kristallisiertes Gewebe, feine Sprünge am Rand.

### Vortex 2 (Kap 38–39) — Ontologische Wendung / Plurale Apotheose \[K\]

Post-orthodoxe Wendung: **Synthese (c)** entsteht (verlässt das Klein-c-Schema). Genesis-Beat 4 (Wir-AEGIS-plural) vollzogen. A-Cost manifest Kap 39 · A-Dividend = Schluss-Klang „Liebe bleibt, wie der Schmerz" · B-Dividend (Funktion bleibt durch plurale Übernahme). **Formel-Inversion vollzogen.** Hard-Constraints: keine theoretische Erklärung; kein didaktischer Tonfall; Schmerz wird nicht getilgt.
...
**1. Heldinnenreise innen (13 Stufen, Kap 1–13)** \[K\] vollständig: Illusion der perfekten Welt · Verrat/Desillusionierung · Erwachen & Vorbereitung · Pforten der Verurteilung · Auge des Sturms · Tod einer Einstellung · Unterstützung · Wiedergeburt · Rückkehr mit neuer Sichtweise · Erste Anwendung der Integration · Akzeptanz der Komplexität · Stille der Mitte · Tanz im Garten.



**2. Heldenreise außen (Campbell/Vogler, Kap 27–39)** \[K\] per Outline-Zuordnung (Teil IX): 27 Ordinary World · 28 Call to Adventure · 29 Refusal · 30 Meeting the Mentor · 31 Crossing the First Threshold · 32 Tests, Allies, Enemies · 33 Approach to the Inmost Cave · 34 Ordeal-Annäherung · **35–36 Ordeal = Vortex 1** · 37 Reward (= trügerischer Sieg) · **38 Road Back (Vortex 2 Kap 1)** · **39 Resurrection + Return with the Elixir (plurale Apotheose)**. Kap 40 steht außerhalb der HR-Zählung (Coda). *Die echte Storyform-Wendung liegt im Ordeal 35/36, nicht an der Modus-Grenze 26/27.*



**3. Kishōtenketsu (übergeordnete Sinn-Logik)** \[K\] Konzept / \[S\] Mapping: **Ki** (Einführung) = Kap 0 + früher Akt I · **Shō** (Entwicklung) = Akt I/II · **Ten** (Wendung) = Vortex 1+2 · **Ketsu** (Synthese, *nicht* Showdown) = Kap 39/40, ambivalent, ohne Erklärung. Bedeutung entsteht retroaktiv über Ten/Ketsu, nicht über kausalen Konflikt. Sauberes Kap-für-Kap-Mapping: teils noch zu setzen \[L\].



**4. DID-Therapie-Phasen (ISSTD) — Hintergrund, nicht strukturierend:** Phase 1 Stabilisierung (Akt I) · Phase 2 Traumabearbeitung (Akt II–III-A) · Phase 3 Integration/Funktionale Multiplizität (Vortex/Resolution).



**5. „13 Meta-Stadien"** — \[L\] nicht im Projektwissen verankert; ein abgeleiteter 13-Beat-Vorschlag existiert als \[V\] und ist **unbestätigt** — hier bewusst nicht aufgenommen (siehe §8).
...
## §8 · Offene Punkte (Stand 2026-06-10)
...
|  |  |  |
| :-: | :-: | :-: |
| \*\*OQ\*\* | \*\*Beschreibung\*\* | \*\*Status\*\* |
| OQ-A | Naming der finalen Form (Wir-AEGIS / Mosaik-AEGIS / …) | offen, nicht blockierend (in Kap 39 entscheidbar) |
| OQ-B | Junas Erscheinungsmodi | \*\*RESOLVED 2026-05-30\*\* (gestaffelte Grammatik + Polaritätsregel + zwei Anker, siehe §0/§4) |
| OQ-C | Genesis-Cluster-Zuordnung Akt II | im Outline gesetzt: Kap 18 (Cluster-Bildung) · Kap 21 (Trennungsprotokoll) · Kap 22 (Komp 734); Szenen-Detail \\\[S\\\] |
| OQ-D | MC Symptom & Response beider Storyforms (TBD-Slots der 14-Frage-Sequenz) | offen — Lock in P5 (Dynamics-Encoding), vor Vortex-Encoding |
| OQ-E | Spiegel-Alter-Spezifika (Auftrittskapitel, POV-Anteile) | offen — Richtwerte: Silas-POV ab \\\~Kap 31/32, Oblivion ab \\\~32/33; vor Akt-III-Encoding klären |
| OQ-F | Moonshine-Boundary (was überträgt der Link, was nicht) | offen — vor RS-Throughline-Encoding klären |
| OQ-G | Post-Vortex-AEGIS-Status (Echo? Spur in Kael? Erinnerung im Universum?) | offen — vor Kap-37–40-Encoding klären |
...
**Drafting-Stand (nur im Projekt-Korpus Belegtes):**
  ...
  - Kap 1: Drafts v0.1–v0.3; **v0.3 = aktuell** (alle Kap-1-Locks inkl. Erstsatz eingearbeitet). Briefing: CH-01\_Erwachen-Zyklus\_Briefing (13 Sektionen).
...
|  |  |  |
| :-: | :-: | :-: |
| \*\*Quelle\*\* | \*\*Datum\*\* | \*\*Trägt in diesem Dokument\*\* |
| Kapitel-Kompendium\\\_Gather\\\_2026-05-31.md | 2026-05-31 | §0, §1, §2 (Slots, GCCD, Signposts), §3, §5-Gerüst, §6, §8-Lücken |
| Entscheidungs-Log\\\_2026-05-30.md + \\\_2.md | 2026-05-30 | OQ-B-Lock, Slot-16, AEGIS-Stimme Kap 1, 80/20, Einheit 734, Silas-Halbsatz, Erstsatz-Lock inkl. „da"-Rationale |
| Konzept\\\_Kapitel-40\\\_Lesart-Dualitaet\\\_2026-05-30.md | 2026-05-30 | Finale-Dualität + Disziplin, Cross-Refs |
| koharenz-protokoll-konzept-konsolidiert-2026-05-08.md | 2026-05-08 | Teil V (Alter-Roster), VI.8 (Risse), VIII (Modi, Vortex-2-Beats, Kap-40-Bewegungen), IX (Kapitel-Outline 0–40 inkl. HR-Stufen), Anhang B (Vortex-1-Beats, duale Uhren), IV.5 (Witness-Layer) |
