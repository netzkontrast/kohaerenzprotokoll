...
| `terms/<slug>.md` | the term census of one document, exhaustive — 22 <!--state:documents.with_census--> | a reader |
| `notes/<slug>.md` | what one document says about the terms that matter, quoting with line numbers — 22 <!--state:documents.with_note--> | a reader |
