...
| `terms/<slug>.md` | the term census of one document, exhaustive — 14 <!--state:documents.with_census--> | a reader |
| `notes/<slug>.md` | what one document says about the terms that matter, quoting with line numbers — 14 <!--state:documents.with_note--> | a reader |
