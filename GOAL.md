...
> - `Wiki/`: 93 <!--state:wiki.pages--> Begriffsseiten, 15 <!--state:wiki.conflicts--> Konflikt-Records und 5 <!--state:wiki.questions--> Fragen-Seiten, jede Aussage mit Zitat und Zeilennummer.
...
> | `entities.jsonl`, `edges.jsonl` | abgeleitet von `scripts/graph.py`: 130 <!--state:graph.nodes--> Knoten, 1641 <!--state:graph.edges--> Kanten, jede mit Datei:Zeile | Begriffe, Dokumente, Konflikte, Fragen. Noch ohne Kapitel, Locks, Figuren-Typen. |
...
> | 7 · Evaluation | `graphrag.py bench`: 20 <!--state:graphrag.cases--> Fälle, Recall@8 70 <!--state:graphrag.recall_ppr-->%. Keine Gold-Q&A. |
>
