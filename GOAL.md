...
> | `entities.jsonl`, `edges.jsonl` | abgeleitet von `scripts/graph.py`: 130 <!--state:graph.nodes--> Knoten, 1617 <!--state:graph.edges--> Kanten, jede mit Datei:Zeile | Begriffe, Dokumente, Konflikte, Fragen. Noch ohne Kapitel, Locks, Figuren-Typen. |
