...
Ihr Hinweis zur deutschen Flexion beim Alias-Matching trifft genau die Lücke, die hier `fold()` und `pairs.py` messen: 43 <!--state:pairs.fold_correct--> von 74 <!--state:pairs.labelled--> Paaren.
