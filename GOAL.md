...
> | `entities.jsonl`, `edges.jsonl` | abgeleitet von `scripts/graph.py`: 122 <!--state:graph.nodes--> Knoten, 1163 <!--state:graph.edges--> Kanten, jede mit Datei:Zeile | Begriffe, Dokumente, Konflikte, Fragen. Noch ohne Kapitel, Locks, Figuren-Typen. |
