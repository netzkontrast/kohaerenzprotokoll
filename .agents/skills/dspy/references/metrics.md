...
`score_rule("fold")`: **80 <!--state:pairs.labelled--> labelled pairs; `fold()`
...
one, `rule:plural`, which decides 54 <!--state:pairs.plural_correct-->
...
46 <!--state:pairs.fold_correct--> of 80
...
- **A judge for job 1 or job 2** — waits on 20–50 hand-labelled cases per the
  calibration protocol's own floor. Job 1's 80 <!--state:pairs.labelled-->
