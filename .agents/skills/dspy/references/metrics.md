...
`score_rule("fold")`: **81 <!--state:pairs.labelled--> labelled pairs; `fold()`
...
46 <!--state:pairs.fold_correct--> of 81
...
- **A judge for job 1 or job 2** — waits on 20–50 hand-labelled cases per the
  calibration protocol's own floor. Job 1's 81 <!--state:pairs.labelled-->
