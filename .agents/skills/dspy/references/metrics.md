...
`score_rule("fold")`: **71 <!--state:pairs.labelled--> labelled pairs; `fold()`
...
41 <!--state:pairs.fold_correct--> of 71
...
- **A judge for job 1 or job 2** — waits on 20–50 hand-labelled cases per the
  calibration protocol's own floor. Job 1's 71 <!--state:pairs.labelled-->
