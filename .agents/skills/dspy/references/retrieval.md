...
1641 <!--state:graph.edges--> edges; the evidence layer holds
2033 <!--state:graph.evidence--> quotations, of which
2033 <!--state:graph.evidence_verified--> verify against their cited line.
