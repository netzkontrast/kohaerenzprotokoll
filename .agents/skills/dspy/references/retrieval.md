...
1605 <!--state:graph.edges--> edges; the evidence layer holds
1903 <!--state:graph.evidence--> quotations, of which
1903 <!--state:graph.evidence_verified--> verify against their cited line.
