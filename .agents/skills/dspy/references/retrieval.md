...
1312 <!--state:graph.edges--> edges; the evidence layer holds
1436 <!--state:graph.evidence--> quotations, of which
1436 <!--state:graph.evidence_verified--> verify against their cited line.
