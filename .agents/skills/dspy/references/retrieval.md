...
2297 <!--state:graph.edges--> edges; the evidence layer holds
3438 <!--state:graph.evidence--> quotations, of which
3438 <!--state:graph.evidence_verified--> verify against their cited line.
