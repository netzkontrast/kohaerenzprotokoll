...
1617 <!--state:graph.edges--> edges; the evidence layer holds
1877 <!--state:graph.evidence--> quotations, of which
1877 <!--state:graph.evidence_verified--> verify against their cited line.
